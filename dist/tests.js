...
/***/ "../build/tests/source/common/basic_point.js":
/*!***************************************************!*\
  !*** ../build/tests/source/common/basic_point.js ***!
  \***************************************************/
...
exports.BasicPoint = BasicPoint;
//# sourceMappingURL=basic_point.js.map

/***/ }),

/***/ "../build/tests/source/eisenhower/threshold_box.js":
/*!*********************************************************!*\
  !*** ../build/tests/source/eisenhower/threshold_box.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports.ThresholdBox = ThresholdBox;
...
/***/ "../build/tests/source/tasks/basic_task_provider.js":
/*!**********************************************************!*\
  !*** ../build/tests/source/tasks/basic_task_provider.js ***!
  \**********************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BasicTaskProvider = void 0;
const basic_task_1 = __webpack_require__(/*! ./basic_task */ "../build/tests/source/tasks/basic_task.js");
class BasicTaskProvider {
    createNewTask() {
        return new basic_task_1.BasicTask("", "unset");
    }
    restoreTasks() {
    ...
    getInitialTasks() {
        ...
        tasks.push(new basic_task_1.BasicTask("Move tasks by dragging them with your mouse", "do", 1));
        tasks.push(new basic_task_1.BasicTask("Create new tasks by moving the \"+\" button onto the board", "do", 2));
        tasks.push(new basic_task_1.BasicTask("Complete tasks by moving them to the \"Done\" box", "schedule", 1));
        tasks.push(new basic_task_1.BasicTask("Remove tasks by moving them to the \"Remove\" box", "delegate", 1));
        tasks.push(new basic_task_1.BasicTask("Double-click a task to edit it", "delegate", 2));
        tasks.push(new basic_task_1.BasicTask("Visit the project's repository by clicking the button at the top of the page", "delete", 1));
        return tasks;
    }
    deleteTask(task) {
...
exports.BasicTaskProvider = BasicTaskProvider;
...
/***/ "../build/tests/tests/eisenhower/threshold_box.test.js":
/*!*************************************************************!*\
  !*** ../build/tests/tests/eisenhower/threshold_box.test.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const threshold_box_1 = __webpack_require__(/*! ../../source/eisenhower/threshold_box */ "../build/tests/source/eisenhower/threshold_box.js");
const basic_point_1 = __webpack_require__(/*! ../../source/common/basic_point */ "../build/tests/source/common/basic_point.js");
const chai_1 = __webpack_require__(/*! chai */ "../node_modules/chai/chai.js");
// class DOMRect {
// 	x: number = 0;
// 	y: number = 0;
...
// 	}
// };
function createTestBox_0_0_10_10() {
    const rect = new DOMRect(0, 0, 10, 10);
    return new threshold_box_1.ThresholdBox(rect);
}
describe('ThresholdBox', () => {
    it("Point far back", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(-5, -5);
        chai_1.assert.equal(box.isAfter(point), true);
    });
    it("Point above", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(5, -5);
    ...
    it("Point above, x infront", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(15, -5);
        chai_1.assert.equal(box.isAfter(point), true);
    });
    it("Point to left", () => {
        const box = createTestBox_0_0_10_10();
    ...
    it("Point to left, y below", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(-5, 15);
        chai_1.assert.equal(box.isAfter(point), false);
    });
    it("Point above diagonal", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(2, 2);
        chai_1.assert.equal(box.isAfter(point), true);
    });
    it("Point below diagonal", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(8, 8);
        chai_1.assert.equal(box.isAfter(point), false);
    });
    it("Point to the right & below", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(15, 15);
        chai_1.assert.equal(box.isAfter(point), false);
    });
    it("Point to the right", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(15, 5);
        chai_1.assert.equal(box.isAfter(point), false);
    });
    ...
    it("ThresholdBox: left below", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(-5, 12);
        chai_1.assert.equal(box.isAfter(point), false);
    });
    it("ThresholdBox: left far below", () => {
        const box = createTestBox_0_0_10_10();
        const point = new basic_point_1.BasicPoint(-5, 18);
        chai_1.assert.equal(box.isAfter(point), false);
    });
});
//# sourceMappingURL=threshold_box.test.js.map
...
describe("BasicTask", () => {
    it("Construction", () => {
        ...
        const taskSection = "do";
        const basicTask = new basic_task_1.BasicTask(taskName, taskSection);
        chai_1.assert.equal(basicTask.getName(), taskName);
        chai_1.assert.equal(basicTask.getSection(), taskSection);
    });
    it("Name setter", () => {
        const basicTask = new basic_task_1.BasicTask("Hello", "unset");
        const newName = "World";
        basicTask.setName(newName);
        chai_1.assert.equal(basicTask.getName(), newName);
    });
    it("Section setter", () => {
        const basicTask = new basic_task_1.BasicTask("Hello", "unset");
        const newSection = "schedule";
        basicTask.setSection(newSection);
        chai_1.assert.equal(basicTask.getSection(), newSection);
    });
    it("Order index setter", () => {
        const basicTask = new basic_task_1.BasicTask("Hello", "unset");
        const newIndex = 31173;
        basicTask.setOrderIndex(newIndex);
        chai_1.assert.equal(basicTask.getOrderIndex(), newIndex);
    });
    it("Unicode symbols in names", () => {
        const taskName = "Привет, Мир!";
        const basicTask = new basic_task_1.BasicTask(taskName, "unset");
        chai_1.assert.equal(basicTask.getName(), taskName);
    });
});
//# sourceMappingURL=basic_task.test.js.map

/***/ }),

/***/ "../build/tests/tests/tasks/basic_task_provider.test.js":
/*!**************************************************************!*\
  !*** ../build/tests/tests/tasks/basic_task_provider.test.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const chai_1 = __webpack_require__(/*! chai */ "../node_modules/chai/chai.js");
const basic_task_provider_1 = __webpack_require__(/*! ../../source/tasks/basic_task_provider */ "../build/tests/source/tasks/basic_task_provider.js");
describe("BasicTaskProvider", () => {
    it("Construction", () => {
        const taskProvider = new basic_task_provider_1.BasicTaskProvider;
    });
    it("Restore tasks - list of initial tasks", () => {
        const taskProvider = new basic_task_provider_1.BasicTaskProvider;
        const tasks = taskProvider.restoreTasks();
        chai_1.assert.lengthOf(tasks, 6);
    });
    it("Create tasks", () => {
        const taskProvider = new basic_task_provider_1.BasicTaskProvider;
        ...
        chai_1.assert.equal(newTask.getName(), newTaskName);
    });
});
//# sourceMappingURL=basic_task_provider.test.js.map
...
webpackContext.id = "../build/tests sync recursive .test.js$";
...
var testsContext = __webpack_require__("../build/tests sync recursive .test.js$");
